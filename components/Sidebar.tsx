    ...
    <div className='bg-dark-1 sticky left-0 top-0 h-screen px-4 md:px-10 py-10 text-white text-[20px] lg:flex lg:flex-col gap-5 hidden'>
      {
        sidebarRoautes.map((route,index)=>(
          <div className='font-bold text-white flex gap-4 cursor-pointer px-4 lg:px-8 py-5 rounded-[14px] justify-center lg:justify-normal items-center' key={index} style={{backgroundColor:path===route.route ? "blue":"inherit"}} onClick={()=>{
