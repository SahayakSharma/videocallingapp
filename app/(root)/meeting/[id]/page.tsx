...
export default function page({ params }: { params: { id: string } }) {
    ...
    return (
        <div className='p-2 sm:p-4 md:p-6 lg:p-10 xl:p-14'>
            <div className='w-[100%] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4'>
                <video className='rounded-[14px] h-[280px] border-2 border-purple-600' ref={localvideoref} autoPlay playsInline muted />
                {
            ...
            <button className='px-4 py-2.5 font-extrabold text-[20px] bg-green-500 rounded-md m-4' onClick={() => {
                console.log(videoMap)
            }}>Get members in room</button>
        </div>
    )
}
